// The following Hebrew date conversion code was taken from www.dafaweek.com/HebCal/HebCalSampleSource.php
...
var getShabbat = function(dateInput){
  if(dateInput.getDay() !== 6){
    var offset = 6 - dateInput.getDay();
    var dateInput = new Date(dateInput.getTime() + (offset*86400000)); /* offset is the number of days until Shabbat, and we multiply that by the number of milliseconds in a day */
  }
  return(dateInput);
}
